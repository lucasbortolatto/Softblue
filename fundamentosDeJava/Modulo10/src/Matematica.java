...
public class Matematica {
	...
	public Double converterAngulo(Double angulo, TipoAngulo tipo){
		...
		this.tipo = tipo;
		if (tipo == tipo.GRAUS){
			System.out.println("Conversão de " + tipo.GRAUS + " em " + tipo.RADIANOS + ":");
			angulo = Math.toRadians(angulo);
		}else{
			System.out.println("Conversão de " + tipo.RADIANOS + " em " + tipo.GRAUS + ":");
	...
	public static Integer converterBinarioParaDecimal(String numBinario){
		System.out.println("Conversão do número binário " + numBinario + " para decimal:");
